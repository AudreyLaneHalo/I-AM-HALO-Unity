        ...
        public class MicControlEditorC : Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                if (ListenToMic.GetComponent<MicControlC>().advanced)
                {
                    ...
                    ProgressBar(ListenToMic.GetComponent<MicControlC>().rawInput, "Raw Input", 18, 20);
                    ...
                    if (ListenToMic.GetComponent<MicControlC>().enableSpectrumData)
                    {
                        ...
                        EditorGUILayout.CurveField(new GUIContent("", "Curve visualization of the spectrumData[]array. This curve can also be sampled through the new spectrumCurve property."), ListenToMic.GetComponent<MicControlC>().spectrumCurve);
