...
/*SF_DATA;ver:1.33;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:3,spmd:1,trmd:0,grmd:0,uamb:True,mssp:False,bkdf:True,hqlp:False,rprd:True,enco:True,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:66,x:32977,y:32223,varname:node_66,prsc:2|diff-1476-OUT,spec-717-OUT,gloss-2171-OUT;n:type:ShaderForge.SFN_TexCoord,id:4940,x:30281,y:32638,varname:node_4940,prsc:2,uv:0;n:type:ShaderForge.SFN_Color,id:3580,x:31592,y:31909,ptovrint:False,ptlb:Color1,ptin:_Color1,varname:node_3580,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0,c3:0,c4:1;n:type:ShaderForge.SFN_Slider,id:717,x:32535,y:32506,ptovrint:False,ptlb:Specular,ptin:_Specular,varname:node_717,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5393327,max:1;n:type:ShaderForge.SFN_Slider,id:2171,x:32535,y:32605,ptovrint:False,ptlb:Gloss,ptin:_Gloss,varname:node_2171,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.2680299,max:1;n:type:ShaderForge.SFN_Multiply,id:5968,x:31639,y:32647,varname:node_5968,prsc:2|A-1585-OUT,B-5184-OUT;n:type:ShaderForge.SFN_Step,id:1585,x:31356,y:32648,varname:node_1585,prsc:2|A-1678-OUT,B-1126-OUT;n:type:ShaderForge.SFN_Vector1,id:1126,x:31060,y:32703,varname:node_1126,prsc:2,v1:0.25;n:type:ShaderForge.SFN_Vector1,id:3420,x:30389,y:32845,varname:node_3420,prsc:2,v1:0.25;n:type:ShaderForge.SFN_Step,id:5721,x:30578,y:32845,varname:node_5721,prsc:2|A-3420-OUT,B-130-OUT;n:type:ShaderForge.SFN_Multiply,id:9014,x:31633,y:32077,varname:node_9014,prsc:2|A-3580-RGB,B-5435-OUT;n:type:ShaderForge.SFN_Set,id:1688,x:30447,y:32638,varname:U,prsc:2|IN-4940-U;n:type:ShaderForge.SFN_Set,id:8853,x:30447,y:32686,varname:V,prsc:2|IN-4940-V;n:type:ShaderForge.SFN_Get,id:1678,x:31039,y:32648,varname:node_1678,prsc:2|IN-1688-OUT;n:type:ShaderForge.SFN_Get,id:130,x:30389,y:32900,varname:node_130,prsc:2|IN-8853-OUT;n:type:ShaderForge.SFN_Step,id:6464,x:31060,y:32781,varname:node_6464,prsc:2|A-9207-OUT,B-8974-OUT;n:type:ShaderForge.SFN_Get,id:9207,x:30872,y:32781,varname:node_9207,prsc:2|IN-1688-OUT;n:type:ShaderForge.SFN_Vector1,id:8974,x:30893,y:32843,varname:node_8974,prsc:2,v1:0.5;n:type:ShaderForge.SFN_Subtract,id:2748,x:31356,y:32785,varname:node_2748,prsc:2|A-6464-OUT,B-1585-OUT;n:type:ShaderForge.SFN_RemapRange,id:8807,x:30578,y:33001,varname:node_8807,prsc:2,frmn:0,frmx:1,tomn:1,tomx:0|IN-5721-OUT;n:type:ShaderForge.SFN_Color,id:1382,x:31816,y:31909,ptovrint:False,ptlb:Color2,ptin:_Color2,varname:_Color2,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0,c2:0.2551723,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:4274,x:31854,y:32077,varname:node_4274,prsc:2|A-1382-RGB,B-6013-OUT;n:type:ShaderForge.SFN_Add,id:7525,x:32520,y:32081,varname:node_7525,prsc:2|A-9014-OUT,B-4274-OUT,C-1276-OUT,D-2937-OUT;n:type:ShaderForge.SFN_Color,id:6547,x:31832,y:32484,ptovrint:False,ptlb:Color6,ptin:_Color6,varname:_Color3,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.7352941,c2:0.3243945,c3:0.723959,c4:1;n:type:ShaderForge.SFN_Multiply,id:5003,x:31833,y:32325,varname:node_5003,prsc:2|A-6547-RGB,B-515-OUT;n:type:ShaderForge.SFN_Color,id:8416,x:31633,y:32484,ptovrint:False,ptlb:Color5,ptin:_Color5,varname:_Color4,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.9736309,c3:0.04411763,c4:1;n:type:ShaderForge.SFN_Multiply,id:7029,x:32024,y:32647,varname:node_7029,prsc:2|A-1585-OUT,B-9613-OUT;n:type:ShaderForge.SFN_Multiply,id:2158,x:31633,y:32325,varname:node_2158,prsc:2|A-8416-RGB,B-8358-OUT;n:type:ShaderForge.SFN_Multiply,id:255,x:32024,y:32784,varname:node_255,prsc:2|A-9613-OUT,B-2748-OUT;n:type:ShaderForge.SFN_Multiply,id:2577,x:31639,y:32784,varname:node_2577,prsc:2|A-2748-OUT,B-5184-OUT;n:type:ShaderForge.SFN_Get,id:8372,x:30872,y:32996,varname:node_8372,prsc:2|IN-1688-OUT;n:type:ShaderForge.SFN_Vector1,id:4300,x:30893,y:33055,varname:node_4300,prsc:2,v1:0.75;n:type:ShaderForge.SFN_Step,id:1467,x:31060,y:32996,varname:node_1467,prsc:2|A-8372-OUT,B-4300-OUT;n:type:ShaderForge.SFN_Subtract,id:6952,x:31356,y:32922,varname:node_6952,prsc:2|A-1467-OUT,B-6464-OUT;n:type:ShaderForge.SFN_Multiply,id:5037,x:32024,y:32920,varname:node_5037,prsc:2|A-6952-OUT,B-9613-OUT;n:type:ShaderForge.SFN_Multiply,id:2886,x:31639,y:32920,varname:node_2886,prsc:2|A-5184-OUT,B-6952-OUT;n:type:ShaderForge.SFN_Multiply,id:3991,x:32015,y:32325,varname:node_3991,prsc:2|A-3028-OUT,B-3019-RGB;n:type:ShaderForge.SFN_Color,id:3019,x:32024,y:32484,ptovrint:False,ptlb:Color7,ptin:_Color7,varname:node_3019,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.09571119,c2:0.6985294,c3:0.04622621,c4:1;n:type:ShaderForge.SFN_Color,id:9588,x:32032,y:31909,ptovrint:False,ptlb:Color3,ptin:_Color3,varname:_Color6,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.04411763,c2:0.8417854,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:1276,x:32036,y:32077,varname:node_1276,prsc:2|A-9588-RGB,B-6132-OUT;n:type:ShaderForge.SFN_Add,id:1476,x:32738,y:32182,varname:node_1476,prsc:2|A-7525-OUT,B-4724-OUT;n:type:ShaderForge.SFN_Add,id:4724,x:32520,y:32328,varname:node_4724,prsc:2|A-2158-OUT,B-5003-OUT,C-3991-OUT,D-7999-OUT;n:type:ShaderForge.SFN_RemapRange,id:8822,x:31356,y:33049,varname:node_8822,prsc:2,frmn:0,frmx:1,tomn:1,tomx:0|IN-1467-OUT;n:type:ShaderForge.SFN_Color,id:3249,x:32242,y:31909,ptovrint:False,ptlb:Color4,ptin:_Color4,varname:_Color7,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.6827586,c3:0,c4:1;n:type:ShaderForge.SFN_Color,id:7213,x:32246,y:32484,ptovrint:False,ptlb:Color8,ptin:_Color8,varname:_Color8,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.4999999,c2:0.375,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:4720,x:31639,y:33066,varname:node_4720,prsc:2|A-8822-OUT,B-5184-OUT;n:type:ShaderForge.SFN_Multiply,id:2937,x:32246,y:32077,varname:node_2937,prsc:2|A-3249-RGB,B-4028-OUT;n:type:ShaderForge.SFN_Multiply,id:5433,x:32024,y:33066,varname:node_5433,prsc:2|A-8822-OUT,B-9613-OUT;n:type:ShaderForge.SFN_Multiply,id:7999,x:32246,y:32325,varname:node_7999,prsc:2|A-7213-RGB,B-8650-OUT;n:type:ShaderForge.SFN_Set,id:7215,x:30544,y:33181,varname:UPSide,prsc:2|IN-2535-OUT;n:type:ShaderForge.SFN_Set,id:6605,x:30758,y:33055,varname:DownSide,prsc:2|IN-8807-OUT;n:type:ShaderForge.SFN_Get,id:5184,x:31356,y:32583,varname:node_5184,prsc:2|IN-7215-OUT;n:type:ShaderForge.SFN_Get,id:9613,x:31826,y:32856,varname:node_9613,prsc:2|IN-6605-OUT;n:type:ShaderForge.SFN_Set,id:6495,x:31832,y:32647,varname:Slot1,prsc:2|IN-5968-OUT;n:type:ShaderForge.SFN_Set,id:1172,x:31832,y:32784,varname:Slot2,prsc:2|IN-2577-OUT;n:type:ShaderForge.SFN_Set,id:9709,x:31832,y:32920,varname:Slot3,prsc:2|IN-2886-OUT;n:type:ShaderForge.SFN_Set,id:3411,x:31832,y:33066,varname:Slot4,prsc:2|IN-4720-OUT;n:type:ShaderForge.SFN_Get,id:5435,x:31612,y:32209,varname:node_5435,prsc:2|IN-6495-OUT;n:type:ShaderForge.SFN_Get,id:6013,x:31833,y:32209,varname:node_6013,prsc:2|IN-1172-OUT;n:type:ShaderForge.SFN_Get,id:6132,x:32015,y:32209,varname:node_6132,prsc:2|IN-9709-OUT;n:type:ShaderForge.SFN_Get,id:4028,x:32225,y:32209,varname:node_4028,prsc:2|IN-3411-OUT;n:type:ShaderForge.SFN_Set,id:5764,x:32191,y:32647,varname:Slot5,prsc:2|IN-7029-OUT;n:type:ShaderForge.SFN_Set,id:8352,x:32191,y:32784,varname:Slot6,prsc:2|IN-255-OUT;n:type:ShaderForge.SFN_Set,id:1254,x:32191,y:32920,varname:Slot7,prsc:2|IN-5037-OUT;n:type:ShaderForge.SFN_Set,id:7672,x:32191,y:33066,varname:Slot8,prsc:2|IN-5433-OUT;n:type:ShaderForge.SFN_Get,id:8358,x:31612,y:32267,varname:node_8358,prsc:2|IN-5764-OUT;n:type:ShaderForge.SFN_Get,id:515,x:31833,y:32267,varname:node_515,prsc:2|IN-8352-OUT;n:type:ShaderForge.SFN_Get,id:3028,x:32015,y:32267,varname:node_3028,prsc:2|IN-1254-OUT;n:type:ShaderForge.SFN_Get,id:8650,x:32225,y:32267,varname:node_8650,prsc:2|IN-7672-OUT;n:type:ShaderForge.SFN_Vector1,id:8420,x:30129,y:33119,varname:node_8420,prsc:2,v1:0.75;n:type:ShaderForge.SFN_Step,id:2535,x:30352,y:33181,varname:node_2535,prsc:2|A-8420-OUT,B-8329-OUT;n:type:ShaderForge.SFN_Get,id:8329,x:30129,y:33191,varname:node_8329,prsc:2|IN-8853-OUT;n:type:ShaderForge.SFN_Color,id:1356,x:31565,y:31563,ptovrint:False,ptlb:Color9,ptin:_Color9,varname:_Color2,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.1985294,c2:0.6359028,c3:0.75,c4:1;n:type:ShaderForge.SFN_Multiply,id:1049,x:31606,y:31731,varname:node_1049,prsc:2|A-1356-RGB;n:type:ShaderForge.SFN_Color,id:9795,x:31789,y:31563,ptovrint:False,ptlb:Color10,ptin:_Color10,varname:_Color3,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5566609,c2:0.6003668,c3:0.7279412,c4:1;n:type:ShaderForge.SFN_Multiply,id:4634,x:31827,y:31731,varname:node_4634,prsc:2|A-9795-RGB;n:type:ShaderForge.SFN_Color,id:7387,x:32005,y:31563,ptovrint:False,ptlb:Color11,ptin:_Color11,varname:_Color4,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.4898796,c2:0.6544118,c3:0.3320177,c4:1;n:type:ShaderForge.SFN_Multiply,id:3831,x:32009,y:31731,varname:node_3831,prsc:2|A-7387-RGB;n:type:ShaderForge.SFN_Color,id:9277,x:32215,y:31563,ptovrint:False,ptlb:Color12,ptin:_Color12,varname:_Color5,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.9673428,c3:0.8970588,c4:1;n:type:ShaderForge.SFN_Multiply,id:567,x:32219,y:31731,varname:node_567,prsc:2|A-9277-RGB;n:type:ShaderForge.SFN_Vector1,id:7009,x:30150,y:33394,varname:node_7009,prsc:2,v1:0.5;n:type:ShaderForge.SFN_Step,id:2116,x:30352,y:33315,varname:node_2116,prsc:2|A-7009-OUT,B-8329-OUT;n:type:ShaderForge.SFN_Subtract,id:9229,x:30548,y:33287,varname:node_9229,prsc:2|A-2116-OUT,B-2535-OUT;n:type:ShaderForge.SFN_Get,id:9926,x:30352,y:32339,varname:node_9926,prsc:2|IN-1688-OUT;n:type:ShaderForge.SFN_Distance,id:7789,x:30551,y:32193,varname:node_7789,prsc:2|A-9926-OUT,B-11-OUT;n:type:ShaderForge.SFN_Step,id:1108,x:30594,y:32016,varname:node_1108,prsc:2|A-7789-OUT,B-1741-OUT;n:type:ShaderForge.SFN_Vector1,id:1741,x:30136,y:32044,varname:node_1741,prsc:2,v1:0.25;n:type:ShaderForge.SFN_Vector1,id:6417,x:30136,y:32092,varname:node_6417,prsc:2,v1:2;n:type:ShaderForge.SFN_Divide,id:1465,x:30352,y:32016,varname:node_1465,prsc:2|A-1741-OUT,B-6417-OUT;n:type:ShaderForge.SFN_Vector1,id:4210,x:29809,y:32161,varname:node_4210,prsc:2,v1:1;n:type:ShaderForge.SFN_Add,id:11,x:30352,y:32183,varname:node_11,prsc:2|A-7203-OUT,B-1465-OUT;n:type:ShaderForge.SFN_Vector1,id:5019,x:30136,y:32204,varname:node_5019,prsc:2,v1:4;n:type:ShaderForge.SFN_Divide,id:7203,x:30136,y:32463,varname:node_7203,prsc:2|A-524-OUT,B-5019-OUT;n:type:ShaderForge.SFN_Vector1,id:9946,x:30136,y:32265,varname:node_9946,prsc:2,v1:1;n:type:ShaderForge.SFN_Subtract,id:524,x:30136,y:32318,varname:node_524,prsc:2|A-4210-OUT,B-9946-OUT;n:type:ShaderForge.SFN_Set,id:7312,x:30824,y:32194,varname:VerticalStripes,prsc:2|IN-1108-OUT;proporder:3580-1382-9588-3249-8416-6547-3019-7213-717-2171;pass:END;sub:END;*/

Shader "Malbers/Colors32" {
    Properties {
...
////// Specular:
                ...
                float V = i.uv0.g;
                float node_8329 = V;
                float node_2535 = step(0.75,node_8329);
                float UPSide = node_2535;
                ...
                float DownSide = (step(0.25,V)*-1.0+1.0);
