/*
  ...
  Plugins/Raymarching Toolkit/Examples/Assets/Fractals/FractalTemplate.shader
  
  for Raymarcher named 'Raymarcher' in scene 'Fractals - Glowing mandelbub'.

*/

Shader "Hidden/_Fractals - Glowing mandelbub_1020040025.generated"
{
...
// Light Light
uniform float4 Light_49623740PosAndRange;
uniform float4 Light_49623740ColorAndIntensity;
uniform float3 Light_49623740Direction;
uniform float Light_49623740Penumbra;
uniform int Light_49623740ShadowSteps;
// Light Light 2
uniform float4 Light2_49623769PosAndRange;
uniform float4 Light2_49623769ColorAndIntensity;
uniform float3 Light2_49623769Direction;
uniform float Light2_49623769Penumbra;
uniform int Light2_49623769ShadowSteps;
...
{
LightInfo light;
light.posAndRange = Light_49623740PosAndRange;
light.colorAndIntensity = Light_49623740ColorAndIntensity;
light.direction = Light_49623740Direction;
lightValue += getDirectionalLight(input, light)* softshadow(input.pos, -light.direction, INFINITY, Light_49623740Penumbra, Light_49623740ShadowSteps);
}
{
LightInfo light;
light.posAndRange = Light2_49623769PosAndRange;
light.colorAndIntensity = Light2_49623769ColorAndIntensity;
light.direction = Light2_49623769Direction;
